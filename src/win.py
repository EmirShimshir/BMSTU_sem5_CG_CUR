...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox.setTitle(_translate("MainWindow", "Параметры модели"))
        self.label.setText(_translate("MainWindow", "Начальная скорость капли:"))
        self.label_2.setText(_translate("MainWindow", "Ускорение капли:"))
        self.label_3.setText(_translate("MainWindow", "Плотность жидкости:"))
        self.groupBox_painting.setTitle(_translate("MainWindow", "Метод закраски"))
        self.guro.setText(_translate("MainWindow", "Закраска по методу Гуро"))
        self.fong.setText(_translate("MainWindow", "Закраска по методу Фонга"))
        self.triangle.setText(_translate("MainWindow", "Отрисовка полигонов"))
        self.groupBox_2.setTitle(_translate("MainWindow", "Камера"))
        self.label_4.setText(_translate("MainWindow", "Перемещение:    кнопки W, A, S, D"))
        self.label_5.setText(_translate("MainWindow", "     Вращение:      кнопки  ↑, ↓, ←, →"))
